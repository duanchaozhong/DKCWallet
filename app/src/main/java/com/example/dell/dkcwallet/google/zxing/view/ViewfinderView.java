...
package com.example.dell.dkcwallet.google.zxing.view;
...
public final class ViewfinderView extends View {
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    labelTextSize = array.getFloat(R.styleable.ViewfinderView_label_text_size, getResources().getDimension(R.dimen.common_45dp));
...
//    canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT, paint);
    ...
    StaticLayout staticLayout = new StaticLayout(labelText, mTextPaint, (int) (ScreenUtils.getScreenWidth(getContext
            ()) * .8f + .5f), Layout.Alignment.ALIGN_NORMAL, 1f, 0f, true);

    canvas.save();
    canvas.translate(frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT);
